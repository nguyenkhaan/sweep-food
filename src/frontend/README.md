...
- Chuỗi text: qua **`context.l10n.<key>`** — key ở `lib/l10n/app_vi.arb` (nguồn) + `app_en.arb` (dịch), chạy `flutter gen-l10n`. App vẫn chạy `vi` duy nhất (M6.1). Vài chuỗi data/nền còn tiếng Việt — xem M6.1 trong `IMPLEMENTATION_PLAN.md`.
