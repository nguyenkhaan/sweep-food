...
class AppConfig {
  ...
  factory AppConfig.fromEnvironment() {
    return AppConfig(
      ...
      // Set to true only after `flutterfire configure` is run.
      fcmEnabled: const bool.fromEnvironment('FCM_ENABLED'),
    );
  }
  ...
  /// Whether Firebase Cloud Messaging is active.
  /// Requires `google-services.json` (Android) / `GoogleService-Info.plist`
  /// (iOS) generated by `flutterfire configure`. Keep `false` until those
  /// files are committed.
  ...
  String toString() =>
      ...
      'nearExpiryDays: $nearExpiryDays, fcmEnabled: $fcmEnabled)';
}
