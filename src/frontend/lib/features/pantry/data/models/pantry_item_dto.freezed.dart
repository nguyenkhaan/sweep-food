...
mixin _$PantryItemDto {
  ...
  double get quantity;
  String get unit;
  @JsonKey(name: 'storage_tier')
  String get storageTier;
  ...
  $PantryItemDtoCopyWith<PantryItemDto> get copyWith =>
      _$PantryItemDtoCopyWithImpl<PantryItemDto>(
          this as PantryItemDto, _$identity);
...
abstract mixin class $PantryItemDtoCopyWith<$Res> {
  factory $PantryItemDtoCopyWith(
          PantryItemDto value, $Res Function(PantryItemDto) _then) =
      _$PantryItemDtoCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String name,
      ...
      double quantity,
      String unit,
      @JsonKey(name: 'storage_tier') String storageTier,
...
extension PantryItemDtoPatterns on PantryItemDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PantryItemDto value)? $default, {
...
class _PantryItemDto extends PantryItemDto {
  const _PantryItemDto(
      {required this.id,
      required this.name,
      required this.category,
      required this.quantity,
      required this.unit,
      @JsonKey(name: 'storage_tier') required this.storageTier,
      @JsonKey(name: 'added_at') required this.addedAt,
      required this.source,
      this.status = 'active',
      @JsonKey(name: 'ingredient_id') this.ingredientId,
      @JsonKey(name: 'packed_date') this.packedDate,
      @JsonKey(name: 'expiry_date') this.expiryDate,
      @JsonKey(name: 'reference_shelf_life_days') this.referenceShelfLifeDays,
      @JsonKey(name: 'price_vnd') this.priceVnd})
      : super._();
  factory _PantryItemDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PantryItemDtoCopyWith<_PantryItemDto> get copyWith =>
      __$PantryItemDtoCopyWithImpl<_PantryItemDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PantryItemDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PantryItemDtoCopyWith<$Res>
    implements $PantryItemDtoCopyWith<$Res> {
  factory _$PantryItemDtoCopyWith(
          _PantryItemDto value, $Res Function(_PantryItemDto) _then) =
      __$PantryItemDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$PantrySummaryDto {
  ...
  int get totalCount;
  @JsonKey(name: 'count_by_tier')
  Map<String, int> get countByTier;
  @JsonKey(name: 'near_expiry')
  List<PantryItemDto> get nearExpiry;
  @JsonKey(name: 'waste_reduction_count')
  int get wasteReductionCount;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PantrySummaryDtoCopyWith<PantrySummaryDto> get copyWith =>
      _$PantrySummaryDtoCopyWithImpl<PantrySummaryDto>(
          this as PantrySummaryDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PantrySummaryDto &&
            (identical(other.totalCount, totalCount) ||
                other.totalCount == totalCount) &&
            const DeepCollectionEquality()
                .equals(other.countByTier, countByTier) &&
            const DeepCollectionEquality()
                .equals(other.nearExpiry, nearExpiry) &&
            (identical(other.wasteReductionCount, wasteReductionCount) ||
                other.wasteReductionCount == wasteReductionCount) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      totalCount,
      const DeepCollectionEquality().hash(countByTier),
      const DeepCollectionEquality().hash(nearExpiry),
      wasteReductionCount,
      wasteAvoidedKg);
...
abstract mixin class $PantrySummaryDtoCopyWith<$Res> {
  factory $PantrySummaryDtoCopyWith(
          PantrySummaryDto value, $Res Function(PantrySummaryDto) _then) =
      _$PantrySummaryDtoCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'total_count') int totalCount,
      @JsonKey(name: 'count_by_tier') Map<String, int> countByTier,
      @JsonKey(name: 'near_expiry') List<PantryItemDto> nearExpiry,
      @JsonKey(name: 'waste_reduction_count') int wasteReductionCount,
...
class _$PantrySummaryDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? countByTier = null,
    Object? nearExpiry = null,
    Object? wasteReductionCount = null,
    Object? wasteAvoidedKg = freezed,
  }) {
    return _then(_self.copyWith(
      totalCount: null == totalCount
          ...
          : totalCount // ignore: cast_nullable_to_non_nullable
              as int,
      countByTier: null == countByTier
          ? _self.countByTier
          : countByTier // ignore: cast_nullable_to_non_nullable
              as Map<String, int>,
      nearExpiry: null == nearExpiry
          ? _self.nearExpiry
          : nearExpiry // ignore: cast_nullable_to_non_nullable
              as List<PantryItemDto>,
      wasteReductionCount: null == wasteReductionCount
          ? _self.wasteReductionCount
          : wasteReductionCount // ignore: cast_nullable_to_non_nullable
              as int,
      wasteAvoidedKg: freezed == wasteAvoidedKg
...
extension PantrySummaryDtoPatterns on PantrySummaryDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PantrySummaryDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PantrySummaryDto() when $default != null:
        return $default(_that.totalCount, _that.countByTier, _that.nearExpiry,
            _that.wasteReductionCount, _that.wasteAvoidedKg);
      case _:
        return orElse();
    }
  }
...
class _PantrySummaryDto extends PantrySummaryDto {
  const _PantrySummaryDto(
      ...
      @JsonKey(name: 'count_by_tier')
      final Map<String, int> countByTier = const {},
      @JsonKey(name: 'near_expiry')
      final List<PantryItemDto> nearExpiry = const [],
      @JsonKey(name: 'waste_reduction_count') this.wasteReductionCount = 0,
      @JsonKey(name: 'waste_avoided_kg') this.wasteAvoidedKg})
      : _countByTier = countByTier,
        _nearExpiry = nearExpiry,
        super._();
  factory _PantrySummaryDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PantrySummaryDtoCopyWith<_PantrySummaryDto> get copyWith =>
      __$PantrySummaryDtoCopyWithImpl<_PantrySummaryDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PantrySummaryDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PantrySummaryDto &&
            (identical(other.totalCount, totalCount) ||
                other.totalCount == totalCount) &&
            const DeepCollectionEquality()
                .equals(other._countByTier, _countByTier) &&
            const DeepCollectionEquality()
                .equals(other._nearExpiry, _nearExpiry) &&
            (identical(other.wasteReductionCount, wasteReductionCount) ||
                other.wasteReductionCount == wasteReductionCount) &&
            (identical(other.wasteAvoidedKg, wasteAvoidedKg) ||
                other.wasteAvoidedKg == wasteAvoidedKg));
  ...
  int get hashCode => Object.hash(
      runtimeType,
      totalCount,
      const DeepCollectionEquality().hash(_countByTier),
      const DeepCollectionEquality().hash(_nearExpiry),
      wasteReductionCount,
      wasteAvoidedKg);
...
/// @nodoc
abstract mixin class _$PantrySummaryDtoCopyWith<$Res>
    implements $PantrySummaryDtoCopyWith<$Res> {
  factory _$PantrySummaryDtoCopyWith(
          _PantrySummaryDto value, $Res Function(_PantrySummaryDto) _then) =
      __$PantrySummaryDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'total_count') int totalCount,
