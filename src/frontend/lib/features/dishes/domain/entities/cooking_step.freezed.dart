...
mixin _$CookingStep {
 ...
 int get order; String get text; int? get durationMin;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CookingStep&&(identical(other.order, order) || other.order == order)&&(identical(other.text, text) || other.text == text)&&(identical(other.durationMin, durationMin) || other.durationMin == durationMin));
}
...
@useResult
$Res call({
 int order, String text, int? durationMin
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int order,  String text,  int? durationMin)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CookingStep() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int order,  String text,  int? durationMin)  $default,) {final _that = this;
switch (_that) {
case _CookingStep():
return $default(_that.order,_that.text,_that.durationMin);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int order,  String text,  int? durationMin)?  $default,) {final _that = this;
switch (_that) {
case _CookingStep() when $default != null:
return $default(_that.order,_that.text,_that.durationMin);case _:
  return null;
...
class _CookingStep extends CookingStep {
  const _CookingStep({required this.order, required this.text, this.durationMin}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CookingStep&&(identical(other.order, order) || other.order == order)&&(identical(other.text, text) || other.text == text)&&(identical(other.durationMin, durationMin) || other.durationMin == durationMin));
}
