...
mixin _$DishIngredient {
  ...
  $DishIngredientCopyWith<DishIngredient> get copyWith =>
      _$DishIngredientCopyWithImpl<DishIngredient>(
          this as DishIngredient, _$identity);
...
abstract mixin class $DishIngredientCopyWith<$Res> {
  factory $DishIngredientCopyWith(
          DishIngredient value, $Res Function(DishIngredient) _then) =
      _$DishIngredientCopyWithImpl;
  @useResult
  $Res call(
      {String name,
      double quantity,
...
class _DishIngredient extends DishIngredient {
  const _DishIngredient(
      {required this.name,
      required this.quantity,
      required this.unit,
      this.isSeasoning = false,
      this.availableInPantry = false,
      this.missingQty = 0,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DishIngredientCopyWith<_DishIngredient> get copyWith =>
      __$DishIngredientCopyWithImpl<_DishIngredient>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DishIngredient &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.quantity, quantity) ||
                other.quantity == quantity) &&
            (identical(other.unit, unit) || other.unit == unit) &&
...
/// @nodoc
abstract mixin class _$DishIngredientCopyWith<$Res>
    implements $DishIngredientCopyWith<$Res> {
  factory _$DishIngredientCopyWith(
          _DishIngredient value, $Res Function(_DishIngredient) _then) =
      __$DishIngredientCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
