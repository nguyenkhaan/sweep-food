...
/// E — how much near-expiry stock the dish uses up.
 double get e;/// A — share of ingredients already in the pantry.
 double get a;/// P — fit with servings, nutrition target and preferences.
 double get p;/// U — how little extra shopping it needs.
 double get u;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScoreBreakdown&&(identical(other.e, e) || other.e == e)&&(identical(other.a, a) || other.a == a)&&(identical(other.p, p) || other.p == p)&&(identical(other.u, u) || other.u == u));
}
...
class _ScoreBreakdown extends ScoreBreakdown {
  const _ScoreBreakdown({this.e = 0, this.a = 0, this.p = 0, this.u = 0}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScoreBreakdown&&(identical(other.e, e) || other.e == e)&&(identical(other.a, a) || other.a == a)&&(identical(other.p, p) || other.p == p)&&(identical(other.u, u) || other.u == u));
}
