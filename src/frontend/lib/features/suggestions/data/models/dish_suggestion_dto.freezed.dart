...
mixin _$DishSuggestionDto {
  DishDto get dish;
  ScoreBreakdownDto? get breakdown;
  @JsonKey(name: 'near_expiry_ingredients')
  List<String> get nearExpiryIngredients;
  @JsonKey(name: 'availability_ratio')
  double get availabilityRatio;
  @JsonKey(name: 'to_buy_count')
  int get toBuyCount;
  int? get score;
  ...
  $DishSuggestionDtoCopyWith<DishSuggestionDto> get copyWith =>
      _$DishSuggestionDtoCopyWithImpl<DishSuggestionDto>(
          this as DishSuggestionDto, _$identity);
  ...
  int get hashCode => Object.hash(
      ...
      dish,
      breakdown,
      const DeepCollectionEquality().hash(nearExpiryIngredients),
      availabilityRatio,
      toBuyCount,
      score);
...
abstract mixin class $DishSuggestionDtoCopyWith<$Res> {
  factory $DishSuggestionDtoCopyWith(
          DishSuggestionDto value, $Res Function(DishSuggestionDto) _then) =
      _$DishSuggestionDtoCopyWithImpl;
  @useResult
  $Res call(
      {DishDto dish,
      ...
      @JsonKey(name: 'availability_ratio') double availabilityRatio,
      @JsonKey(name: 'to_buy_count') int toBuyCount,
      int? score});
...
class _$DishSuggestionDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? nearExpiryIngredients = null,
    Object? availabilityRatio = null,
    Object? toBuyCount = null,
    ...
    return _then(_self.copyWith(
      ...
      breakdown: freezed == breakdown
          ...
          : breakdown // ignore: cast_nullable_to_non_nullable
              as ScoreBreakdownDto?,
      nearExpiryIngredients: null == nearExpiryIngredients
          ? _self.nearExpiryIngredients
          : nearExpiryIngredients // ignore: cast_nullable_to_non_nullable
              as List<String>,
      availabilityRatio: null == availabilityRatio
          ? _self.availabilityRatio
          : availabilityRatio // ignore: cast_nullable_to_non_nullable
              as double,
      toBuyCount: null == toBuyCount
          ? _self.toBuyCount
          : toBuyCount // ignore: cast_nullable_to_non_nullable
              as int,
      score: freezed == score
          ? _self.score
...
extension DishSuggestionDtoPatterns on DishSuggestionDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DishSuggestionDto value)? $default, {
    ...
    switch (_that) {
      case _DishSuggestionDto() when $default != null:
        return $default(
            _that.dish,
            _that.breakdown,
            _that.nearExpiryIngredients,
            _that.availabilityRatio,
            _that.toBuyCount,
            _that.score);
      case _:
        return orElse();
...
class _DishSuggestionDto extends DishSuggestionDto {
  const _DishSuggestionDto(
      {required this.dish,
      this.breakdown,
      @JsonKey(name: 'near_expiry_ingredients')
      final List<String> nearExpiryIngredients = const <String>[],
      @JsonKey(name: 'availability_ratio') this.availabilityRatio = 0,
      @JsonKey(name: 'to_buy_count') this.toBuyCount = 0,
      this.score})
      : _nearExpiryIngredients = nearExpiryIngredients,
        super._();
  factory _DishSuggestionDto.fromJson(Map<String, dynamic> json) =>
      _$DishSuggestionDtoFromJson(json);

  @override
  final DishDto dish;
  @override
  final ScoreBreakdownDto? breakdown;
  final List<String> _nearExpiryIngredients;
  @override
  @JsonKey(name: 'near_expiry_ingredients')
  List<String> get nearExpiryIngredients {
    if (_nearExpiryIngredients is EqualUnmodifiableListView)
      return _nearExpiryIngredients;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DishSuggestionDtoCopyWith<_DishSuggestionDto> get copyWith =>
      __$DishSuggestionDtoCopyWithImpl<_DishSuggestionDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DishSuggestionDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DishSuggestionDto &&
            (identical(other.dish, dish) || other.dish == dish) &&
            (identical(other.breakdown, breakdown) ||
                other.breakdown == breakdown) &&
            const DeepCollectionEquality()
                .equals(other._nearExpiryIngredients, _nearExpiryIngredients) &&
            (identical(other.availabilityRatio, availabilityRatio) ||
                other.availabilityRatio == availabilityRatio) &&
            (identical(other.toBuyCount, toBuyCount) ||
                other.toBuyCount == toBuyCount) &&
  ...
  int get hashCode => Object.hash(
      ...
      dish,
      breakdown,
      const DeepCollectionEquality().hash(_nearExpiryIngredients),
      availabilityRatio,
      toBuyCount,
      score);
...
/// @nodoc
abstract mixin class _$DishSuggestionDtoCopyWith<$Res>
    implements $DishSuggestionDtoCopyWith<$Res> {
  factory _$DishSuggestionDtoCopyWith(
          _DishSuggestionDto value, $Res Function(_DishSuggestionDto) _then) =
      __$DishSuggestionDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {DishDto dish,
...
mixin _$ScoreBreakdownDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ScoreBreakdownDtoCopyWith<ScoreBreakdownDto> get copyWith =>
      _$ScoreBreakdownDtoCopyWithImpl<ScoreBreakdownDto>(
          this as ScoreBreakdownDto, _$identity);
...
abstract mixin class $ScoreBreakdownDtoCopyWith<$Res> {
  factory $ScoreBreakdownDtoCopyWith(
          ScoreBreakdownDto value, $Res Function(ScoreBreakdownDto) _then) =
      _$ScoreBreakdownDtoCopyWithImpl;
  @useResult
...
extension ScoreBreakdownDtoPatterns on ScoreBreakdownDto {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ScoreBreakdownDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ScoreBreakdownDto extends ScoreBreakdownDto {
  const _ScoreBreakdownDto({this.e = 0, this.a = 0, this.p = 0, this.u = 0})
      : super._();
  factory _ScoreBreakdownDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScoreBreakdownDtoCopyWith<_ScoreBreakdownDto> get copyWith =>
      __$ScoreBreakdownDtoCopyWithImpl<_ScoreBreakdownDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScoreBreakdownDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ScoreBreakdownDtoCopyWith<$Res>
    implements $ScoreBreakdownDtoCopyWith<$Res> {
  factory _$ScoreBreakdownDtoCopyWith(
          _ScoreBreakdownDto value, $Res Function(_ScoreBreakdownDto) _then) =
      __$ScoreBreakdownDtoCopyWithImpl;
  @override
  @useResult
  $Res call({double e, double a, double p, double u});
}
