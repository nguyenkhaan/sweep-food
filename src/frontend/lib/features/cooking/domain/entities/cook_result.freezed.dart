...
mixin _$PantryChange {
  ...
  $PantryChangeCopyWith<PantryChange> get copyWith =>
      _$PantryChangeCopyWithImpl<PantryChange>(
          this as PantryChange, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PantryChange &&
...
abstract mixin class $PantryChangeCopyWith<$Res> {
  factory $PantryChangeCopyWith(
          PantryChange value, $Res Function(PantryChange) _then) =
      _$PantryChangeCopyWithImpl;
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class _$PantryChangeCopyWithImpl<$Res> implements $PantryChangeCopyWith<$Res> {
...
extension PantryChangePatterns on PantryChange {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PantryChange value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, MeasurementUnit unit, double before,
            double after, bool nearExpiryUsed, String? pantryItemId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _PantryChange extends PantryChange {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PantryChangeCopyWith<_PantryChange> get copyWith =>
      __$PantryChangeCopyWithImpl<_PantryChange>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PantryChange &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.unit, unit) || other.unit == unit) &&
            (identical(other.before, before) || other.before == before) &&
            (identical(other.after, after) || other.after == after) &&
...
/// @nodoc
abstract mixin class _$PantryChangeCopyWith<$Res>
    implements $PantryChangeCopyWith<$Res> {
  factory _$PantryChangeCopyWith(
          _PantryChange value, $Res Function(_PantryChange) _then) =
      __$PantryChangeCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
...
mixin _$CookResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CookResultCopyWith<CookResult> get copyWith =>
      _$CookResultCopyWithImpl<CookResult>(this as CookResult, _$identity);
...
abstract mixin class $CookResultCopyWith<$Res> {
  factory $CookResultCopyWith(
          CookResult value, $Res Function(CookResult) _then) =
      _$CookResultCopyWithImpl;
  @useResult
  $Res call(
      {String dishId,
      String dishName,
      List<PantryChange> changes,
      List<PantryItem> updatedPantryItems,
      List<String> depletedItemIds,
      int nearExpiryUsedCount,
      double wasteAvoidedGrams,
      int leftoverServings});
}

/// @nodoc
class _$CookResultCopyWithImpl<$Res> implements $CookResultCopyWith<$Res> {
...
extension CookResultPatterns on CookResult {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CookResult value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _CookResult extends CookResult {
  const _CookResult(
      {this.dishId = '',
      this.dishName = '',
      final List<PantryChange> changes = const <PantryChange>[],
      final List<PantryItem> updatedPantryItems = const <PantryItem>[],
      final List<String> depletedItemIds = const <String>[],
      this.nearExpiryUsedCount = 0,
      this.wasteAvoidedGrams = 0,
      this.leftoverServings = 0})
      : _changes = changes,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CookResultCopyWith<_CookResult> get copyWith =>
      __$CookResultCopyWithImpl<_CookResult>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CookResult &&
            (identical(other.dishId, dishId) || other.dishId == dishId) &&
            (identical(other.dishName, dishName) ||
                other.dishName == dishName) &&
...
/// @nodoc
abstract mixin class _$CookResultCopyWith<$Res>
    implements $CookResultCopyWith<$Res> {
  factory _$CookResultCopyWith(
          _CookResult value, $Res Function(_CookResult) _then) =
      __$CookResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String dishId,
...
/// @nodoc
class __$CookResultCopyWithImpl<$Res> implements _$CookResultCopyWith<$Res> {
