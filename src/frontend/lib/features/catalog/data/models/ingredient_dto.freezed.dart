...
mixin _$IngredientDto {
 ...
 String get id; String get name; String get category;@JsonKey(name: 'default_unit') String get defaultUnit;@JsonKey(name: 'nutrition_per_100g') NutritionPer100gDto? get nutritionPer100g;@JsonKey(name: 'reference_shelf_life_days') int? get referenceShelfLifeDays;
...
@useResult
$Res call({
 String id, String name, String category,@JsonKey(name: 'default_unit') String defaultUnit,@JsonKey(name: 'nutrition_per_100g') NutritionPer100gDto? nutritionPer100g,@JsonKey(name: 'reference_shelf_life_days') int? referenceShelfLifeDays
});
...
as NutritionPer100gDto?,referenceShelfLifeDays: freezed == referenceShelfLifeDays ? _self.referenceShelfLifeDays : referenceShelfLifeDays // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
/// Create a copy of IngredientDto
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String category, @JsonKey(name: 'default_unit')  String defaultUnit, @JsonKey(name: 'nutrition_per_100g')  NutritionPer100gDto? nutritionPer100g, @JsonKey(name: 'reference_shelf_life_days')  int? referenceShelfLifeDays)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IngredientDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String category, @JsonKey(name: 'default_unit')  String defaultUnit, @JsonKey(name: 'nutrition_per_100g')  NutritionPer100gDto? nutritionPer100g, @JsonKey(name: 'reference_shelf_life_days')  int? referenceShelfLifeDays)  $default,) {final _that = this;
switch (_that) {
case _IngredientDto():
return $default(_that.id,_that.name,_that.category,_that.defaultUnit,_that.nutritionPer100g,_that.referenceShelfLifeDays);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String category, @JsonKey(name: 'default_unit')  String defaultUnit, @JsonKey(name: 'nutrition_per_100g')  NutritionPer100gDto? nutritionPer100g, @JsonKey(name: 'reference_shelf_life_days')  int? referenceShelfLifeDays)?  $default,) {final _that = this;
switch (_that) {
case _IngredientDto() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.defaultUnit,_that.nutritionPer100g,_that.referenceShelfLifeDays);case _:
  return null;
...
class _IngredientDto extends IngredientDto {
  const _IngredientDto({required this.id, required this.name, required this.category, @JsonKey(name: 'default_unit') this.defaultUnit = 'g', @JsonKey(name: 'nutrition_per_100g') this.nutritionPer100g, @JsonKey(name: 'reference_shelf_life_days') this.referenceShelfLifeDays}): super._();
...
@override@JsonKey(name: 'nutrition_per_100g') final  NutritionPer100gDto? nutritionPer100g;
...
@override $NutritionPer100gDtoCopyWith<$Res>? get nutritionPer100g;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NutritionPer100gDtoCopyWith<NutritionPer100gDto> get copyWith => _$NutritionPer100gDtoCopyWithImpl<NutritionPer100gDto>(this as NutritionPer100gDto, _$identity);
...
abstract mixin class $NutritionPer100gDtoCopyWith<$Res>  {
  factory $NutritionPer100gDtoCopyWith(NutritionPer100gDto value, $Res Function(NutritionPer100gDto) _then) = _$NutritionPer100gDtoCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NutritionPer100gDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NutritionPer100gDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NutritionPer100gDto value)?  $default,){
final _that = this;
switch (_that) {
case _NutritionPer100gDto() when $default != null:
return $default(_that);case _:
...
class _NutritionPer100gDto extends NutritionPer100gDto {
  const _NutritionPer100gDto({@JsonKey(name: 'energy_kcal') this.energyKcal = 0, @JsonKey(name: 'protein_g') this.proteinG = 0, @JsonKey(name: 'carb_g') this.carbG = 0, @JsonKey(name: 'lipid_g') this.lipidG = 0}): super._();
  factory _NutritionPer100gDto.fromJson(Map<String, dynamic> json) => _$NutritionPer100gDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$NutritionPer100gDtoCopyWith<_NutritionPer100gDto> get copyWith => __$NutritionPer100gDtoCopyWithImpl<_NutritionPer100gDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$NutritionPer100gDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NutritionPer100gDto&&(identical(other.energyKcal, energyKcal) || other.energyKcal == energyKcal)&&(identical(other.proteinG, proteinG) || other.proteinG == proteinG)&&(identical(other.carbG, carbG) || other.carbG == carbG)&&(identical(other.lipidG, lipidG) || other.lipidG == lipidG));
}
...
/// @nodoc
abstract mixin class _$NutritionPer100gDtoCopyWith<$Res> implements $NutritionPer100gDtoCopyWith<$Res> {
  factory _$NutritionPer100gDtoCopyWith(_NutritionPer100gDto value, $Res Function(_NutritionPer100gDto) _then) = __$NutritionPer100gDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'energy_kcal') double energyKcal,@JsonKey(name: 'protein_g') double proteinG,@JsonKey(name: 'carb_g') double carbG,@JsonKey(name: 'lipid_g') double lipidG
});
