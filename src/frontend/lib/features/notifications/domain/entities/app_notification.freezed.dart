...
@useResult
$Res call({
 String id, AppNotificationType type, String title, String body, DateTime createdAt, bool read, String? pantryItemId, List<String> dishIds
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  AppNotificationType type,  String title,  String body,  DateTime createdAt,  bool read,  String? pantryItemId,  List<String> dishIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppNotification() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  AppNotificationType type,  String title,  String body,  DateTime createdAt,  bool read,  String? pantryItemId,  List<String> dishIds)  $default,) {final _that = this;
switch (_that) {
case _AppNotification():
return $default(_that.id,_that.type,_that.title,_that.body,_that.createdAt,_that.read,_that.pantryItemId,_that.dishIds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  AppNotificationType type,  String title,  String body,  DateTime createdAt,  bool read,  String? pantryItemId,  List<String> dishIds)?  $default,) {final _that = this;
switch (_that) {
case _AppNotification() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.createdAt,_that.read,_that.pantryItemId,_that.dishIds);case _:
  return null;
...
class _AppNotification extends AppNotification {
  const _AppNotification({required this.id, required this.type, required this.title, required this.body, required this.createdAt, this.read = false, this.pantryItemId, final  List<String> dishIds = const []}): _dishIds = dishIds,super._();
