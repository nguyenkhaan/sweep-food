...
mixin _$SubscriptionDto {
 ...
 String get tier; List<String> get perks;@JsonKey(name: 'premium_interest_registered') bool get premiumInterestRegistered;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubscriptionDto&&(identical(other.tier, tier) || other.tier == tier)&&const DeepCollectionEquality().equals(other.perks, perks)&&(identical(other.premiumInterestRegistered, premiumInterestRegistered) || other.premiumInterestRegistered == premiumInterestRegistered));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tier,const DeepCollectionEquality().hash(perks),premiumInterestRegistered);
...
@useResult
$Res call({
 String tier, List<String> perks,@JsonKey(name: 'premium_interest_registered') bool premiumInterestRegistered
});
...
/// Create a copy of SubscriptionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tier = null,Object? perks = null,Object? premiumInterestRegistered = null,}) {
...
as List<String>,premiumInterestRegistered: null == premiumInterestRegistered ? _self.premiumInterestRegistered : premiumInterestRegistered // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String tier,  List<String> perks, @JsonKey(name: 'premium_interest_registered')  bool premiumInterestRegistered)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionDto() when $default != null:
return $default(_that.tier,_that.perks,_that.premiumInterestRegistered);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String tier,  List<String> perks, @JsonKey(name: 'premium_interest_registered')  bool premiumInterestRegistered)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionDto():
return $default(_that.tier,_that.perks,_that.premiumInterestRegistered);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String tier,  List<String> perks, @JsonKey(name: 'premium_interest_registered')  bool premiumInterestRegistered)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionDto() when $default != null:
return $default(_that.tier,_that.perks,_that.premiumInterestRegistered);case _:
  return null;
...
class _SubscriptionDto extends SubscriptionDto {
  const _SubscriptionDto({required this.tier, final  List<String> perks = const <String>[], @JsonKey(name: 'premium_interest_registered') this.premiumInterestRegistered = false}): _perks = perks,super._();
...
@override@JsonKey(name: 'premium_interest_registered') final  bool premiumInterestRegistered;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubscriptionDto&&(identical(other.tier, tier) || other.tier == tier)&&const DeepCollectionEquality().equals(other._perks, _perks)&&(identical(other.premiumInterestRegistered, premiumInterestRegistered) || other.premiumInterestRegistered == premiumInterestRegistered));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tier,const DeepCollectionEquality().hash(_perks),premiumInterestRegistered);
...
/// Create a copy of SubscriptionDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tier = null,Object? perks = null,Object? premiumInterestRegistered = null,}) {
