...
mixin _$WasteReductionBar {
  ...
  $WasteReductionBarCopyWith<WasteReductionBar> get copyWith =>
      _$WasteReductionBarCopyWithImpl<WasteReductionBar>(
          this as WasteReductionBar, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WasteReductionBar &&
...
abstract mixin class $WasteReductionBarCopyWith<$Res> {
  factory $WasteReductionBarCopyWith(
          WasteReductionBar value, $Res Function(WasteReductionBar) _then) =
      _$WasteReductionBarCopyWithImpl;
  @useResult
...
extension WasteReductionBarPatterns on WasteReductionBar {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WasteReductionBar value)? $default, {
...
class _WasteReductionBar implements WasteReductionBar {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WasteReductionBarCopyWith<_WasteReductionBar> get copyWith =>
      __$WasteReductionBarCopyWithImpl<_WasteReductionBar>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WasteReductionBar &&
            (identical(other.label, label) || other.label == label) &&
            (identical(other.value, value) || other.value == value));
  }
...
/// @nodoc
abstract mixin class _$WasteReductionBarCopyWith<$Res>
    implements $WasteReductionBarCopyWith<$Res> {
  factory _$WasteReductionBarCopyWith(
          _WasteReductionBar value, $Res Function(_WasteReductionBar) _then) =
      __$WasteReductionBarCopyWithImpl;
  @override
  @useResult
  $Res call({String label, int value});
}
...
mixin _$WasteReductionCategory {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WasteReductionCategoryCopyWith<WasteReductionCategory> get copyWith =>
      _$WasteReductionCategoryCopyWithImpl<WasteReductionCategory>(
          this as WasteReductionCategory, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WasteReductionCategory &&
...
abstract mixin class $WasteReductionCategoryCopyWith<$Res> {
  factory $WasteReductionCategoryCopyWith(WasteReductionCategory value,
          $Res Function(WasteReductionCategory) _then) =
      _$WasteReductionCategoryCopyWithImpl;
  @useResult
  $Res call({String category, int count, int colorValue});
}
...
extension WasteReductionCategoryPatterns on WasteReductionCategory {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WasteReductionCategory value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String category, int count, int colorValue)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _WasteReductionCategory() when $default != null:
        return $default(_that.category, _that.count, _that.colorValue);
      case _:
        return orElse();
    }
  }
...
class _WasteReductionCategory implements WasteReductionCategory {
  const _WasteReductionCategory(
      {required this.category, required this.count, required this.colorValue});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WasteReductionCategoryCopyWith<_WasteReductionCategory> get copyWith =>
      __$WasteReductionCategoryCopyWithImpl<_WasteReductionCategory>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WasteReductionCategory &&
            (identical(other.category, category) ||
                other.category == category) &&
            (identical(other.count, count) || other.count == count) &&
            (identical(other.colorValue, colorValue) ||
...
/// @nodoc
abstract mixin class _$WasteReductionCategoryCopyWith<$Res>
    implements $WasteReductionCategoryCopyWith<$Res> {
  factory _$WasteReductionCategoryCopyWith(_WasteReductionCategory value,
          $Res Function(_WasteReductionCategory) _then) =
      __$WasteReductionCategoryCopyWithImpl;
  @override
  @useResult
  $Res call({String category, int count, int colorValue});
}
...
mixin _$WasteReductionSummary {
  ...
  List<WasteReductionBar> get weeklyBars;
  List<WasteReductionCategory> get byCategory;

  /// Create a copy of WasteReductionSummary
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WasteReductionSummaryCopyWith<WasteReductionSummary> get copyWith =>
      _$WasteReductionSummaryCopyWithImpl<WasteReductionSummary>(
          this as WasteReductionSummary, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WasteReductionSummary &&
...
abstract mixin class $WasteReductionSummaryCopyWith<$Res> {
  factory $WasteReductionSummaryCopyWith(WasteReductionSummary value,
          $Res Function(WasteReductionSummary) _then) =
      _$WasteReductionSummaryCopyWithImpl;
  @useResult
  $Res call(
      {ReportPeriod period,
      String periodLabel,
      ...
      int dishesCooked,
      List<WasteReductionBar> weeklyBars,
...
extension WasteReductionSummaryPatterns on WasteReductionSummary {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WasteReductionSummary value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _WasteReductionSummary extends WasteReductionSummary {
  const _WasteReductionSummary(
      {required this.period,
      required this.periodLabel,
      required this.itemsUsedBeforeExpiry,
      required this.wasteAvoidedKg,
      required this.dishesCooked,
      final List<WasteReductionBar> weeklyBars = const <WasteReductionBar>[],
      final List<WasteReductionCategory> byCategory =
          const <WasteReductionCategory>[]})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WasteReductionSummaryCopyWith<_WasteReductionSummary> get copyWith =>
      __$WasteReductionSummaryCopyWithImpl<_WasteReductionSummary>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WasteReductionSummary &&
            (identical(other.period, period) || other.period == period) &&
            (identical(other.periodLabel, periodLabel) ||
                other.periodLabel == periodLabel) &&
            (identical(other.itemsUsedBeforeExpiry, itemsUsedBeforeExpiry) ||
...
/// @nodoc
abstract mixin class _$WasteReductionSummaryCopyWith<$Res>
    implements $WasteReductionSummaryCopyWith<$Res> {
  factory _$WasteReductionSummaryCopyWith(_WasteReductionSummary value,
          $Res Function(_WasteReductionSummary) _then) =
      __$WasteReductionSummaryCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ReportPeriod period,
