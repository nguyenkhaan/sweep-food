...
mixin _$ShoppingList {
 ...
 String get id;/// "Từ thực đơn tuần 09/09 – 15/09 · 8 món · đối chiếu với tủ bếp"
 String? get sourceLabel; List<ShoppingListItem> get items;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ShoppingList&&(identical(other.id, id) || other.id == id)&&(identical(other.sourceLabel, sourceLabel) || other.sourceLabel == sourceLabel)&&const DeepCollectionEquality().equals(other.items, items));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? sourceLabel,  List<ShoppingListItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShoppingList() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? sourceLabel,  List<ShoppingListItem> items)  $default,) {final _that = this;
switch (_that) {
case _ShoppingList():
return $default(_that.id,_that.sourceLabel,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? sourceLabel,  List<ShoppingListItem> items)?  $default,) {final _that = this;
switch (_that) {
case _ShoppingList() when $default != null:
return $default(_that.id,_that.sourceLabel,_that.items);case _:
  return null;
...
class _ShoppingList extends ShoppingList {
  const _ShoppingList({required this.id, this.sourceLabel, final  List<ShoppingListItem> items = const <ShoppingListItem>[]}): _items = items,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShoppingList&&(identical(other.id, id) || other.id == id)&&(identical(other.sourceLabel, sourceLabel) || other.sourceLabel == sourceLabel)&&const DeepCollectionEquality().equals(other._items, _items));
}
